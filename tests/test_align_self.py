...
class TestAlignSelf:
    ...
    def test_align_self_flex_end(self):
        config = Config()
        root = Node(config)
        root.position_type = PositionType.Absolute
        root.width = YGValuePoint(100)
    ...
    def test_align_self_flex_start(self):
        config = Config()
        root = Node(config)
        root.position_type = PositionType.Absolute
        root.width = YGValuePoint(100)
    ...
    def test_align_self_flex_end_override_flex_start(self):
        config = Config()
        root = Node(config)
    ...
    def test_align_self_baseline(self):
        config = Config()
        root = Node(config)
